class MoDay
    ...
    def list_and_pick_genres
        ...
        picked_genre = Genre.find_by_name(TTY::Prompt.new.select(Pastel.new.cyan("\nPlease pick a genre:"), options))
        puts "\n"
    ...
    def input_handler(entry:, genre:, object:, attribute:)
        ...
        if instance_movies.empty?
            ...
            picked_movie_name = TTY::Prompt.new.select(Pastel.new.cyan("Pick a movie for details:"), movie_titles)
